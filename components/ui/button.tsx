...
const variantClasses: Record<Variant, string> = {
  ...
  outline:
    "border border-white/20 bg-white/10 text-white shadow-[0_10px_24px_rgba(0,0,0,0.12)] backdrop-blur hover:-translate-y-0.5 hover:bg-white/16 hover:text-white",
  light:
